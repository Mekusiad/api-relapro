Com base nos arquivos que você forneceu, parece que você tem um backend de uma aplicação Node.js (provavelmente Express) que lida com autenticação e uma variedade de funcionalidades relacionadas a "home" (que parece ser um painel de controle ou área logada).

Vou criar um `README.md` que descreva essa estrutura e funcionalidades.

```markdown
# Nome do Projeto (Sugestão: Sistema de Gestão de Ordens de Serviço ou similar)

Este projeto é o backend de uma aplicação que gerencia ordens de serviço (OS), funcionários, componentes, equipamentos e subestações. Ele oferece funcionalidades de autenticação de usuários e controle de acesso baseado em nível.
...
3.  **Configurar Variáveis de Ambiente:**
    ...
    PORT=3000
    ```
    *Substitua os valores pelos dados do seu banco de dados e por uma chave secreta forte para o JWT.*
...
Espero que este `README.md` seja útil para você! Sinta-se à vontade para adaptá-lo e adicionar mais detalhes específicos do seu projeto.
````
